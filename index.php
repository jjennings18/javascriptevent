	...
	<body>
		...
		<section>
			<div class="container-fluid">
				<div id="sec1" class="p-3 mb-2 bg-secondary">
				<P>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque rutrum mattis sagittis.
					...
					Aliquam nec tincidunt ligula, et condimentum erat. Maecenas accumsan justo sed nulla ultrices, in
					venenatis leo ultrices. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</P>
				</div>
			</div>
		</section>
		...
		<section>
			<div class="container-fluid"">
				<div id= "sec2" class="p-3 mb-2 bg-secondary">
				<p>Donec et ultricies magna, nec varius mi. Sed volutpat tellus ac arcu mollis vestibulum. Aenean tempus
					...
					faucibus orci luctus et ultrices posuere cubilia Curae; Donec libero diam, interdum ac leo in, molestie
					egestas risus. Ut ullamcorper euismod massa vitae congue. Donec non fringilla purus, eget cursus neque.
					Suspendisse ut enim ut erat convallis iaculis. Praesent sit amet orci sagittis, tincidunt ex quis,
					tristique tortor. Curabitur hendrerit eget neque ac facilisis. Sed lorem leo, sodales at tempus vitae,
					congue ac urna. Sed finibus aliquam luctus.</p>
				</div>
			</div>
		</section>
		...
		<section>
			<div class="container-fluid">
				<div id="sec3" class="p-3 mb-2 bg-secondary">
